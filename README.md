...
Windows x64: %APPDATA%\Rack2\plugins\
```
...
| Windows | MSVC (Visual Studio Build Tools 2019+) or MinGW-w64 via MSYS2 |
...
#### Option 1: Using MSYS2 (recommended for GitHub Actions compatibility)
...
1. Install [Visual Studio Build Tools 2019 or 2022](https://visualstudio.microsoft.com/downloads/)
...
#### Option 3: Using Chocolatey (for GNU Make on Windows)
